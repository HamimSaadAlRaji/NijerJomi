...
import { Settings, Users, Activity, Database, BarChart, Shield } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Manage the blockchain land registry platform and monitor system health
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <Card className="hover:shadow-elevated transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">Configure blockchain and platform settings</p>
              ...
              <Card className="hover:shadow-elevated transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">Monitor security and audit logs</p>
              ...
              <Card className="hover:shadow-elevated transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">Monitor blockchain transactions</p>
              ...
              <Card className="hover:shadow-elevated transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">View detailed system analytics</p>
              ...
              <Card className="hover:shadow-elevated transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-4">Manage database and backups</p>
                  <Button variant="outline" className="w-full">Database</Button>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {[
                    { action: "Property Registration Approved", time: "2 minutes ago", status: "success" },
                    { action: "New User Registration", time: "5 minutes ago", status: "info" },
                    { action: "Smart Contract Deployment", time: "10 minutes ago", status: "success" },
