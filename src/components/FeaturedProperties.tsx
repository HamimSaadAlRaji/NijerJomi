...
import { MapPin, Eye, Shield, Zap, TrendingUp } from "lucide-react";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Explore blockchain-verified properties with complete transparency and secure ownership through NFT tokenization.
          </p>
        </div>
            ...
            >
              <CardHeader className="p-0">
                <div className="relative overflow-hidden rounded-t-lg">
                  ...
                  {/* NFT Glow Effect */}
                  <div className="absolute inset-0 bg-gradient-nft opacity-0 group-hover:opacity-20 transition-opacity duration-500"></div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center pt-4 border-t border-border">
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-sm font-mono text-foreground">{property.id}</div>
                    </div>
                  </div>
                </div>
              </CardContent>
        ...
        <div className="text-center">
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-card rounded-xl p-6 border border-border hover:shadow-property transition-all duration-300">
              ...
              <h3 className="font-semibold text-foreground mb-2">Recently Tokenized</h3>
              <p className="text-muted-foreground text-sm">Latest properties converted to NFTs on the blockchain</p>
            </div>
            ...
            <div className="bg-card rounded-xl p-6 border border-border hover:shadow-property transition-all duration-300">
              ...
              <h3 className="font-semibold text-foreground mb-2">Available for Transfer</h3>
              <p className="text-muted-foreground text-sm">Properties ready for immediate blockchain transfer</p>
            </div>
            ...
            <div className="bg-card rounded-xl p-6 border border-border hover:shadow-property transition-all duration-300">
              ...
              <p className="text-muted-foreground text-sm">Government-verified with complete legal compliance</p>
            </div>
          </div>
