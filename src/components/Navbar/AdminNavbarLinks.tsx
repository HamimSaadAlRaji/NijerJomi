    ...
    <nav className="flex gap-6 items-center">
      <Link
        ...
        className={`${linkBase} ${linkColor} ${
          ["/admin/dashboard", "/dashboard"].includes(location.pathname)
            ? "underline"
            : ""
        }`}
      >
      ...
      <Link
        ...
        className={`${linkBase} ${linkColor} ${
          isActive("/admin/verify-user") ? "underline" : ""
        }`}
      >
        Verify Users
      </Link>
      {isAdmin && (
        <Link
          ...
          className={`${linkBase} ${linkColor} ${
            isActive("/admin/set-user-role") ? "underline" : ""
          }`}
        >
          Manage Roles
        </Link>
      ...
      <Link
        ...
        className={`${linkBase} ${linkColor} ${
          isActive("/admin/property-management") ? "underline" : ""
        }`}
      >
        Property Management
      </Link>
