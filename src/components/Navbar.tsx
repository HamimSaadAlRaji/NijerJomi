...
const Navbar = () => {
  ...
  const getNavbarStyles = () => {
    if (!isLandingPage) {
      ...
      return "fixed top-0 w-full z-50 bg-gradient-to-r from-slate-700/90 via-green-500/90 to-green-900/90 dark:from-slate-900/90 dark:via-green-800/90 dark:to-slate-900/90 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-700/50 transition-all duration-300";
    }
